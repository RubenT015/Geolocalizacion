package com.example.alumnom.geolocalizacion;
...
public class MainActivity extends AppCompatActivity implements  ActivityCompat.OnRequestPermissionsResultCallback, LocationListener{
    ...
    public void getLocalizacion() {
        ...
        mejorProovedor = String.valueOf(locationManager.getBestProvider(criteria, true)).toString();
        ...
        Location location = locationManager.getLastKnownLocation(mejorProovedor);
        if(location!=null){
            ...
            Toast.makeText(getApplicationContext(),"Determinando nueva ubicación",Toast.LENGTH_SHORT).show();
            locationManager.requestLocationUpdates(mejorProovedor,1000,0,this);
        }
    }
